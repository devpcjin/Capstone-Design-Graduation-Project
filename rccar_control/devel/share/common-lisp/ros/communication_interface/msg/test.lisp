...
(cl:defmethod cl:initialize-instance :after ((m <test>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'test)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name communication_interface-msg:<test> is deprecated: use communication_interface-msg:test instead.")))
